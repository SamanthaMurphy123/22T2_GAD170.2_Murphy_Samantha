...
public class StatsSystem : MonoBehaviour
{
   ...
   [SerializeField] private Character character;
    ...
    public void CalculateDancingStats()
    {
        ...
        // now that we have some stats and our multiplier values let's calculate our style, luck and rhythm based on these values, hint your going to need to convert ints to floats, then floats to ints.
